...
class SearchViewModel @Inject constructor(private val discoverRepository: DiscoverRepository) : ViewModel(){

    private var moviePageLiveData: MutableLiveData<SearchModel> = MutableLiveData()
    ...
    init {
        ...
        movieListLiveData = moviePageLiveData.switchMap {
            moviePageLiveData.value?.let {
                discoverRepository.loadSearchedMovies(it) }
    ...
    fun postMoviePage(page: Int,searched : String) = moviePageLiveData.postValue(SearchModel(page,searched))
